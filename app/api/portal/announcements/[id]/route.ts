...
import { updateAnnouncement, deleteAnnouncement } from '@/lib/portal/announcementsStore';
...
export async function PUT(req: NextRequest, context: RouteContext) {
  ...
  try {
    ...
    const entry = await updateAnnouncement(context.params.id, parsed);
...
export async function DELETE(req: NextRequest, context: RouteContext) {
  ...
  try {
    await deleteAnnouncement(context.params.id);
